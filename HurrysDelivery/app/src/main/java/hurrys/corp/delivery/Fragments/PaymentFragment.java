...
import hurrys.corp.delivery.Models.Payment.Payment;
import hurrys.corp.delivery.Models.Payment.ViewHolder;
...
public class PaymentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mref = mFirebaseDatabase.getReference().child("DeliveryPartner").child(sessions.getusername()).child("Transactions");
        ...
        FirebaseDatabase.getInstance().getReference().child("DeliveryPartner").child(session.getusername())
                .child("BankName")
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
        ...
        FirebaseDatabase.getInstance().getReference().child("DeliveryPartner").child(sessions.getusername())
                .child("PendingAmount")
